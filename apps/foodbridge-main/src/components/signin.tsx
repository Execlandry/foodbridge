    ...
    <main className="h-screen w-full banner">
      <div className="flex flex-col justify-center items-center pt-10">
          ...
          {error && (
            ...
            >
              ...
              <span className="block sm:inline">
                User Not Found, Please check user credentials !!
              </span>
            </div>
          )}
        </div>
        <form className="bg-white w-96 mt-6 p-4 rounded-lg shadow-lg">
          ...
          <button
            onClick={(e) => signIn(e)}
            className="w-full py-3 bg-primary text-white focus:outline-none focus:ring-4 mt-6 rounded-lg transition duration-300 hover:bg-primary-dark poppins"
          >
            Sign In
          </button>
          <Link to="/signup">
          ...
          >
            ...
            <div className="flex items-center space-x-3 justify-center border border-gray-300 rounded-lg w-full py-3 cursor-pointer hover:bg-orange-600 text-white bg-orange-500">
