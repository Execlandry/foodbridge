...
export default function Login() {
  const Google = () => {
    window.open(`http://localhost:3001/api/v1/user-service/auth/google`,"_self");
  };
    ...
    <main className="h-screen w-full banner">
      <div className="flex flex-col justify-center items-center pt-10">
        ...
        <form className="bg-white w-96 mt-6 p-4 rounded-lg shadow-lg">
          ...
          <button className="w-full py-3 bg-primary text-white ring-red-400 focus:outline-none focus:ring-4 mt-6 rounded-lg transition duration-300 hover:bg-primary-dark poppins">
            Sign In
          </button>
          <Link to="/signup">
