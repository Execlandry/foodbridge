      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-gray-600">{order.business.address.name} {order.business.address.street} {order.business.address.city} {order.business.address.state} {order.business.address.country}</p>
          </div>
