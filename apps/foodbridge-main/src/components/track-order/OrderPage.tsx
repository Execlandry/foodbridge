...
import {fetchAllOrders,OrderItemsSelector} from "../../redux/order/order.slice";
...
//   const [refreshing, setRefreshing] = useState(false);
  ...
  const completedOrders = orderData.filter((order:any) => order.order_status === 'delivered');
  const pendingOrders = orderData.filter((order:any) => order.order_status !== 'delivered');
