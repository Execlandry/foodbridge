    ...
    <>
      ...
      <div className="flex mx-auto bg-slate-100 ">
            ...
            <>
              ...
              <h2 className=" text-2xl pb-8 font-medium">Order Details</h2>
                ...
                <h2 className="text-2xl font-medium">Business Details</h2>
                  ...
                  />
                  <h1 className="text-lg leading-5 font-bold first-letter:capitalize">{orderData?.business?.name}</h1>
                  <h6 className="text-sm mb-4">{orderData?.business?.description}</h6>
                </div>
        ...
        <div className=" w-[80%] bg-white p-8">
          <MapboxMap lat={Number(orderData.business?.latitude)}  lon={Number(orderData.business?.longitude)} ></MapboxMap>
        </div>
      </div>
    </>
  );
