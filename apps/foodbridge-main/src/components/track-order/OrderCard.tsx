  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 mb-4 transition-all duration-300 hover:shadow-lg">
      <div className="flex justify-between items-start">
        <div>
          <h3 className="text-lg font-semibold text-gray-800">{order.business.name}</h3>
          <p className="text-sm text-gray-500">{order.business.address.name} {order.business.address.street} {order.business.address.city} {order.business.address.state} {order.business.address.country},{order.business.address.pincode}</p>
