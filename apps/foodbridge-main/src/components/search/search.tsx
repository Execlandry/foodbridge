...
const Search = () => {
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => {
      (async () => {
        storeDispatch(filteredBusinesses(`search_text=${dishSearch}`));
      })();
    }, 700);
        ...
        <div className="max-w-[1000px] mt-14 m-auto">
          <div className="flex items-center bg-white border">
            <input
              ...
              type="text "
              placeholder="Search for business and food..."
            />
            {
              <svg
          ...
          <div className="grid grid-cols-8 text-center w-[90%] mx-auto">
            <div>
              <img src={biryaniImg} alt="bir" />
            </div>
            <div>
              <img src={pizza} alt="bir" />
            </div>
            <div>
              <img src={burger} alt="burger" />
            </div>
            <div>
              <img src={cakeDessert} alt="bir" />
            </div>
            <div>
              <img src={north} alt="bir" />
            </div>
            <div>
              <img src={south} alt="bir" />
            </div>
            <div>
              <img src={roll} alt="bir" />
            </div>
            <div>
              <img src={iceCream} alt="bir" />
            </div>
          </div>
          <br />
